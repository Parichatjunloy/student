...
function Delete() {
  return (
    <>
    <Sidebaradmin />
      <div className="w-[500px] h-[200px] bg-white absolute inset-0 z-20 mt-50 ml-138 rounded-2xl">
          ...
          <div className="flex gap-5 ml-22.5 mt-5">
            ...
            <Link to= "/Courseadmin"><button className="bg-[#FFD15F] w-[150px] h-[40px] rounded-xl font-bold cursor-pointer text-white">ยืนยัน</button></Link>
          </div>
      </div>
