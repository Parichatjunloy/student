    ...
    <>
      ...
      <div className="w-[500px] h-[200px] bg-white absolute inset-0 z-20 mt-47 ml-138 rounded-2xl">
          ...
          <div className="flex gap-5 ml-22.5 mt-5">
            <Link to= "/Manageuse"><button className="border-[#FFD15F] border-2 w-[150px] h-[40px] rounded-xl font-bold cursor-pointer">ย้อนกลับ</button></Link>
            <Link to= "/Manageuse"><button className="bg-[#FFD15F] w-[150px] h-[40px] rounded-xl font-bold cursor-pointer text-white">ยืนยัน</button></Link>
          </div>
      </div>
                ...
                <tbody>
                  ...
                  {currentUsers.map((user, index) => (
                    <tr key={index}>
                      ...
                      <td className="pl-8 border-b" style={{ borderColor: "rgba(0,0,0,0.2)" }}><i className="fa-solid fa-trash-can text-red-600" style={{ fontSize: "20px" }}></i></td>
                    </tr>
                  ))}
                </tbody>
              </table>
