        ...
        <div className="bg-[#F2F2F2] w-[750px] h-[360px] mt-6 ml-6 rounded-xl">
          ...
          <div className="flex">
            <div>
              ...
              <input type="text" className="ml-8 mt-2 w-[325px] h-[30px] bg-white border-1 border-gray-300 pl-1 text-[15px]" value="แฟชั่นและสิ่งทอ"/>
            </div>
            <div>
              <p className="text-[#767676] pl-8 pt-3">ชื่อย่อ</p>
              <input type="text" className="ml-8 mt-2 w-[325px] h-[30px] bg-white border-1 border-gray-300 pl-1 text-[15px]" value="ฟท."/>
            </div>
          </div>
          <div className="flex">
            <div>
              <p className="text-[#767676] pl-8 pt-3">ชื่อหลักสูตร (ภาษาอังกฤษ)</p>
              <input type="text" className="ml-8 mt-2 w-[325px] h-[30px] bg-white border-1 border-gray-300 pl-1 text-[15px]" value="Fashion and Textue"/>
            </div>
            <div>
